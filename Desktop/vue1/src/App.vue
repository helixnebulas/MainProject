<template>
  <div id="app">
    <nav id="topblock" class="navbar navbar-light bg-light">
      <div class="container-fluid">
        <a id="navtext" class="navbar-brand" href="#">
          <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-umbrella" viewBox="0 0 16 16">
          ...
          Nazvanie
            ...
            <form class="d-flex">
               <input class="form-control me-2" type="search" placeholder="Что найти?" aria-label="Поиск">
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><router-link tag="button" 
            :to="{path: '/' }">Главная</router-link></li>
